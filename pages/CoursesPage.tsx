...
import { PlayCircle, Clock, Star, Users, BookOpen, ChevronLeft, ChevronRight } from 'lucide-react';
...
const CoursesPage: React.FC = () => {
    ...
    const scroll = (direction: 'left' | 'right') => {
        if (scrollContainerRef.current) {
            ...
            const scrollAmount = container.clientWidth * 0.85; // Scroll by one card width (approx)
            container.scrollBy({
                ...
                {loading ? (
                    ...
                    <div className="relative group/carousel">
                        ...
                        <div
                            ...
                            className="flex md:grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 overflow-x-auto md:overflow-visible pb-8 snap-x snap-mandatory px-4 md:px-0 -mx-4 md:mx-0 scrollbar-hide"
                        >
