    ...
    >
      <div className="relative group/carousel">
        <button
          ...
          className="md:hidden absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-white/80 dark:bg-gray-800/80 backdrop-blur p-2 rounded-full shadow-lg border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-200 -ml-2 opacity-0 group-hover/carousel:opacity-100 transition-opacity"
